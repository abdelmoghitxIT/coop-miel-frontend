...
export default function VerifierEmail({ token, onRetourConnexion }) {
    ...
    const validerEmail = async () => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          // Redirection automatique vers la connexion après 4 secondes
          setTimeout(() => onRetourConnexion(), 4000);
        } else {
          setStatut("erreur");
