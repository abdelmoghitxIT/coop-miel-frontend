...
export default function MotDePasseOublie() {
  ...
  return (
      <div style={{
        ...
        <h2 style={{ color: "var(--accent)", margin: "0 0 8px" }}>{t.motDePasseOublie}</h2>
        ...
        {envoye ? (
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <input
              ...
              style={{
                width: "100%", padding: "12px", borderRadius: "8px", border: "1.5px solid var(--border-input)",
                fontSize: "14px", boxSizing: "border-box", background: "var(--page-bg)", color: "var(--text-primary)", outline: "none",
              }}
            ...
            <button type="submit" disabled={chargement} style={{
              ...
              background: chargement ? "rgba(212,168,84,0.2)" : "linear-gradient(135deg, var(--accent), var(--accent-dark))", color: "#0a0a0a", fontWeight: "700", fontSize: "15px",
              cursor: chargement ? "not-allowed" : "pointer",
            }}>
              {chargement ? t.envoi : t.envoyerLien}
            </button>
            <button type="button" onClick={() => navigate('/login')} style={{
              background: "none", border: "none", cursor: "pointer", fontSize: "13px", color: "var(--accent)",
