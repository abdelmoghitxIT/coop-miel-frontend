...
export default function APropos() {
  ...
  return (
    <div style={{
      ...
      {/* Hero */}
      <div style={{
        background: "linear-gradient(135deg, var(--accent-dark) 0%, var(--accent) 50%, var(--accent) 100%)",
        ...
        <h2 style={{ margin: "0 0 12px", fontSize: "32px", fontWeight: "800", color: "var(--text-primary)", fontFamily: isAr ? "'Amiri', serif" : "'Playfair Display', serif" }}>
          {isAr ? INFO.nom_ar : INFO.nom_fr}
        </h2>
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "48px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px", marginBottom: "48px" }}>
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ fontSize: "28px", fontWeight: "800", color: "var(--accent)", marginBottom: "4px" }}>{stat.value}</div>
              <div style={{ fontSize: "13px", color: "var(--text-muted)", fontWeight: "600" }}>{stat.label}</div>
            </div>
          ))}
        </div>

        {/* Notre histoire */}
        <div style={{ background: "var(--card-bg)", borderRadius: "16px", padding: "32px", border: "1px solid var(--border)", marginBottom: "24px" }}>
          <h3 style={{
            margin: "0 0 16px", fontSize: "22px", fontWeight: "800", color: "var(--text-primary)",
            fontFamily: isAr ? "'Amiri', serif" : "'Playfair Display', serif",
          }}>
            {isAr ? "🍯 قصتنا" : "🍯 Notre histoire"}
          </h3>
          <p style={{ margin: 0, fontSize: "15px", color: "var(--text-secondary)", lineHeight: "1.9", fontFamily: isAr ? "'Amiri', serif" : "'DM Sans', sans-serif" }}>
        ...
        <div style={{ background: "var(--card-bg)", borderRadius: "16px", padding: "32px", border: "1px solid var(--border)", marginBottom: "24px" }}>
          <h3 style={{
            margin: "0 0 20px", fontSize: "22px", fontWeight: "800", color: "var(--text-primary)",
            fontFamily: isAr ? "'Amiri', serif" : "'Playfair Display', serif",
          }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ fontSize: "15px", fontWeight: "700", color: "var(--text-primary)", marginBottom: "6px" }}>{v.title}</div>
                <div style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: "1.6" }}>{v.desc}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Contact */}
        <div style={{ background: "linear-gradient(135deg, var(--accent-dark), var(--accent))", borderRadius: "16px", padding: "32px", color: "#0a0a0a" }}>
          <h3 style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
            {[
              ...
              <div key={i} style={{
                background: "var(--border-input)", borderRadius: "12px", padding: "16px",
